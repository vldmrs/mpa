...
Equation form:
			a_1{\frac{\partial^2{u}}{\partial{x^2}}}+a_2{\frac{\partial{u}}{\partial{x}}}+a_3u+f(x,t)=
...
Output:
matrix with length(grid.t) rows and length(grid.x) columns whose cells are the appropriate values of the function to be solved

P.S. mpa.0.run.R may be used as demo.
